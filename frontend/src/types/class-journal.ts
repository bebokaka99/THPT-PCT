import type { DailyScheduleItem } from './schedule-override';
...
export type ClassJournalOption = DailyScheduleItem & { journal_date: string };

export type ClassJournalReport = {
